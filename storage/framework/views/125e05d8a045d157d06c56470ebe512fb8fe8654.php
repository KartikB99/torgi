<form class="form bravo-form-register" method="post" action="<?php echo e(route('auth.register.store')); ?>">
    ...
    <div class="form-group">
        <input type="text" class="form-control" name="passport" autocomplete="off" placeholder="<?php echo e(__('Passport')); ?>">
        <i class="input-icon field-icon icofont-mail"></i>
...
<?php /**PATH C:\xampp\htdocs\torgi\modules/Layout/auth/register-form.blade.php ENDPATH**/ ?>