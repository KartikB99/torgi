            ...
            <?php else: ?>
                ...
                <div class="smart-search">
                    <input type="text" class="smart-search-location parent_text form-control"
                           <?php echo e(( empty(setting_item("hotel_location_search_style")) or setting_item("hotel_location_search_style") == "normal" ) ? "readonly" : ""); ?> placeholder="<?php echo e(__("Where are you going?")); ?>"
...
<?php /**PATH C:\xampp\htdocs\torgi\themes/BC/Hotel/Views/frontend/layouts/search-map/fields/location.blade.php ENDPATH**/ ?>