...
<?php $__env->startPush('js'); ?>
    ...
    <script>
        var bravo_map_data = {
            ...
            map_lat_default:<?php echo e(setting_item('hotel_map_lat_default','0')); ?>,
            map_lng_default:<?php echo e(setting_item('hotel_map_lng_default','0')); ?>,
            map_zoom_default:<?php echo e(setting_item('hotel_map_zoom_default','0')); ?>,
        };
    </script>
    <script type="text/javascript" src="<?php echo e(asset("libs/ion_rangeslider/js/ion.rangeSlider.min.js")); ?>"></script>
    <script type="text/javascript" src="<?php echo e(asset('module/hotel/js/hotel-map.js?_ver='.config('app.asset_version'))); ?>"></script>

<?php $__env->stopPush(); ?>

<?php echo $__env->make('layouts.app',['container_class'=>'container-fluid','header_right_menu'=>true], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\torgi\themes/BC/Hotel/Views/frontend/search-map.blade.php ENDPATH**/ ?>