...
<?php $__env->startSection('content'); ?>
    <h2 class="title-bar">
        ...
        <?php if(Auth::user()->hasPermission('hotel_create') && empty($recovery)): ?>
            <a href="<?php echo e(route("hotel.vendor.create")); ?>" class="btn-change-password"><?php echo e(__("")); ?></a>
        <?php endif; ?>
    </h2>
...
<?php echo $__env->make('layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\booking\themes/BC/Hotel/Views/frontend/vendorHotel/index.blade.php ENDPATH**/ ?>