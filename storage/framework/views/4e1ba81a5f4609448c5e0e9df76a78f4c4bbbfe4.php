            ...
            <div class="header-left">
                <a href="<?php echo e(url(app_get_locale(false,'/'))); ?>" class="bravo-logo">
                    ...
                    <?php if($logo_id): ?>
                        ...
                        <img src="<?php echo e(asset('images/Torgi_logo.png')); ?>" style="width: 92px;" alt="<?php echo e(setting_item("site_title")); ?>">
                    <?php endif; ?>
                </a>
...
<?php /**PATH C:\xampp\htdocs\booking\modules/Layout/parts/header.blade.php ENDPATH**/ ?>