...
<?php $__env->startSection('content'); ?>
    <h2 class="title-bar">
        ...
        <div class="title-action">
            ...
            <a href="<?php echo e(route("hotel.vendor.room.importview",['hotel_id'=>$hotel->id])); ?>" class="btn btn-success"><i class="fa fa-plus" aria-hidden="true"></i> <?php echo e(__("Import Room")); ?></a>
        </div>
    </h2>
...
<?php echo $__env->make('layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\booking\themes/BC/Hotel/Views/frontend/vendorHotel/room/index.blade.php ENDPATH**/ ?>