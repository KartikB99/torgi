...
Route::group(['prefix'=>'user/'.config('hotel.hotel_route_prefix'),'middleware' => ['auth','verified']],function(){
    ...
    /*-Import-*/
    Route::get('/importview','ImportController@importview')->name('hotel.vendor.importview');
    Route::post('/import', 'ImportController@import')->name('hotel.vendor.import');
    Route::get('/download/{filename}', 'ImportController@download')->name('download');
    ...
    Route::group(['prefix'=>'room'],function (){
        ...
        /*-Import-*/
        Route::get('/roomimportview','ImportController@roomimportview')->name('hotel.vendor.room.importview');
        Route::post('/roomimport', 'ImportController@roomimport')->name('hotel.vendor.room.import');
        /*--*/
    });
