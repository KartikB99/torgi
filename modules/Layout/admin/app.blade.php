            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-6 copy-right" >
                        {{date('Y')}} &copy; {{__('Booking Management System by')}} <a href="{{__('https://www.solutel.sa')}}" target="_blank">{{__('Solutel')}}</a>
                    </div>
                    <div class="col-md-6">
                        <div class="text-md-right footer-links d-none d-sm-block">
                            <a href="{{__('https://www.solutel.sa')}}" target="_blank">{{__('About Us')}}</a>
                            <a href="{{__('https://www.solutel.sa/contact')}}" target="_blank">{{__('Contact Us')}}</a>
                        </div>
                    </div>
                </div>
            </div>
